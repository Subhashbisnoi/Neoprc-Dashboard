...
const rows = [
  {
    ...
    boxplotTitle: 'Validation Edits Index(per Article)',
    cards: [
    ...
    chartData: [12000, 18000, 10000, 15000, 11000, 21000],
  ...
  },
  {
    ...
    chartTitle2: 'Validation Value Index per Article (75th Percentile)',
    boxplotTitle: 'Validation Value Index(per Article)',
    cards: [
      { label: 'Total Articles', value: '83%', change: '+11.01%', positive: true },
      { label: 'Validation Value Index per Article', value: '28', change: '-0.03%', positive: false },
    ],
    chartData: [9000, 13000, 2000, 10000, 8000, 11000],
    chartLabels: ['JAN', 'FEB', 'MARCH', 'APRIL', 'MAY', 'JUN'],
    boxplot: boxPlotData.additionalEditsBoxplot,
  },
  {
    ...
    boxplotTitle: 'Validation Additional Action Index(per Article)',
    cards: [
    ...
    chartData: [6000, 12000, 9000, 10000, 11000, 13500],
    chartLabels: ['JAN', 'FEB', 'MARCH', 'APRIL', 'MAY', 'JUN'],
    boxplot: boxPlotData.additionalEditsBoxplot,
  },
  {
    ...
    boxplotTitle: 'Incomplete Validation Index(per Article)',
    cards: [
    ...
    chartData: [22000, 6000, 19000, 17000, 18000, 12000],
    chartLabels: ['JAN', 'FEB', 'MARCH', 'APRIL', 'MAY', 'JUN'],
    boxplot: boxPlotData.additionalEditsBoxplot,
  },
];
